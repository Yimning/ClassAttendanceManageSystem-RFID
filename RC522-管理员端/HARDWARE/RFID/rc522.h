...
#define SET_SPI_CS  GPIO_SetBits(GPIOF,GPIO_Pin_13)	  //SPI2的片选端（使能），不同通信时写0
#define CLR_SPI_CS  GPIO_ResetBits(GPIOF,GPIO_Pin_13)
#define SET_RC522RST  GPIO_SetBits(GPIOF,GPIO_Pin_14)	  //RC522复位引脚
#define CLR_RC522RST  GPIO_ResetBits(GPIOF,GPIO_Pin_14)
